...
rust_library(
    ...
    srcs = glob(["**/*.rs"]),
    crate_type = "lib",
    deps = ["@crates_io_cfg_if_1.0.0//:cfg_if", "@crates_io_num_traits_0.2.12//:num_traits", "@crates_io_uom_0.30.0//:uom"] + select({"@io_bazel_rules_rust//rust/platform:x86_64-pc-windows-msvc": ["@crates_io_winapi_0.3.9//:winapi"], "//conditions:default": [], "@io_bazel_rules_rust//rust/platform:x86_64-unknown-linux-gnu": ["@crates_io_lazycell_1.3.0//:lazycell"], "@io_bazel_rules_rust//rust/platform:x86_64-apple-darwin": ["@crates_io_core_foundation_0.7.0//:core_foundation", "@crates_io_libc_0.2.79//:libc", "@crates_io_mach_0.3.2//:mach"]}),
    proc_macro_deps = [],
    edition = "2018",
    crate_features = [],
    rustc_flags = ["--cap-lints=allow"] + [],
...
rust_library(
    ...
    srcs = glob(["**/*.rs"]),
    crate_type = "lib",
    deps = ["@crates_io_log_0.4.11//:log", "@crates_io_serde_1.0.115//:serde"] + select({"//conditions:default": [], "@io_bazel_rules_rust//rust/platform:x86_64-pc-windows-msvc": ["@crates_io_winapi_0.3.9//:winapi"]}),
    proc_macro_deps = [],
    edition = "2018",
